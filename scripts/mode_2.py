...
if __name__=="__main__":
    ...
    while(rospy.has_param("/mode")):
        ...
        #Mode 2 choosen by the user
        if mode_ == 2: 
            key = getKey(key_timeout) #Getting the input command
            ...
            if idle == True: 
                pub_thread.STOP() 
                print(module.bcolors.GREEN + module.bcolors.BOLD + "Modality 2 is currently in idle state\n" + module.bcolors.END)
            idle = False
